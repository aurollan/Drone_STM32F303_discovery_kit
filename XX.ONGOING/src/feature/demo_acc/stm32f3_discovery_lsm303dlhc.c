 ...
 *lsm303dlhc MEMS accelerometer available on STM32F3-Discovery Kit.
 ******************************************************************************
 * @attention
 *
 ...
 * @param  LSM303DLHC_FilterStruct: pointer to a LSM303DLHC_FilterConfigTypeDef
 * structure that contains the configuration setting for the LSM303DLHC.
 * @retval None
 */
 ...
 * @param  LSM303DLHC_IT: specifies the LSM303DLHC interrupt source to be
 * enabled. This parameter can be any combination of the following values:
 ...
 * @param  LSM303DLHC_InitStruct: pointer to a LSM303DLHC_MagInitTypeDef
 * structure that contains the configuration setting for the LSM303DLHC.
 * @retval None
 */
...
uint16_t LSM303DLHC_Write(uint8_t DeviceAddr, uint8_t RegAddr,
  ...
  /* Configure slave address, nbytes, reload, end mode and start or stop
   * generation */
 ...
 * @param  DeviceAddr : specifies the slave address to be
 * programmed(ACC_I2C_ADDRESS or MAG_I2C_ADDRESS).
 * @param  RegAddr : specifies the LSM303DLHC internal address register to read
 * from.
 * @param  pBuffer : pointer to the buffer that receives the data read from the
 * LSM303DLH.
 * @param  NumByteToRead : number of bytes to read from the LSM303DLH (
...
uint16_t LSM303DLHC_Read(uint8_t DeviceAddr, uint8_t RegAddr, uint8_t *pBuffer,
  ...
  /* Configure slave address, nbytes, reload, end mode and start or stop
   * generation */
  I2C_TransferHandling(LSM303DLHC_I2C, DeviceAddr, NumByteToRead,
...
static void LSM303DLHC_LowLevel_Init(void) {
  ...
  RCC_AHBPeriphClockCmd(
      LSM303DLHC_I2C_SCK_GPIO_CLK | LSM303DLHC_I2C_SDA_GPIO_CLK, ENABLE);
  ...
  GPIO_PinAFConfig(LSM303DLHC_I2C_SCK_GPIO_PORT, LSM303DLHC_I2C_SCK_SOURCE,
                   LSM303DLHC_I2C_SCK_AF);
  GPIO_PinAFConfig(LSM303DLHC_I2C_SDA_GPIO_PORT, LSM303DLHC_I2C_SDA_SOURCE,
                   LSM303DLHC_I2C_SDA_AF);
