/**
  ******************************************************************************
  * @file    I2C/I2C_TwoBoards/stm32f30x_i2c_cpal_usercallback.c
...
extern uint8_t Buffer_Check(uint8_t* pBuffer, uint8_t* pBuffer1, uint8_t* pBuffer2,  uint8_t* pBuffer3, uint32_t BufferLength);
...
void CPAL_I2C_RXTC_UserCallback(CPAL_InitTypeDef* pDevInitStruct)
{
  ...
  result = Buffer_Check(tRxBuffer, (uint8_t*)tStateSignal, (uint8_t*)tSignal1, (uint8_t*)tSignal2, BufferSize);
